...
package com.vango.testing.performance.capture
{
    ...
    /**
     * Class used for referencing testing repositories that contain different test set results
     */
    internal class PerformanceRegistry
    {
        ...
        /**
         * Singleton instance should not be instantiated. Instead use @see com.vango.testing.performance.capture.PerformanceRegistry.instance
        ...
        /**
         * Retrieves a testing repository for the specified target. This is where testing metrics
        ...
        /**
         * Determines whether a testing repository has been created for the object
         *
        ...
        /**
         * Removes a testing repository for a specific class
         *
        ...
        /**
         * Removes all the registered testing repositories
         */
